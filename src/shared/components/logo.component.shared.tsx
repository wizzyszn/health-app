...
function Logo({ isBackground = false, isExpanded = true }: Props) {
  return (
    <div
      className={`flex gap-2 items-center ${isExpanded ? "min-w-[8.125rem]" : "min-w-0 justify-center w-full pl-0"} py-[0.563rem] px-[0.5rem] ${isBackground && " bg-primary-foreground rounded-[12px]"} transition-all duration-300`}
    >
      <svg

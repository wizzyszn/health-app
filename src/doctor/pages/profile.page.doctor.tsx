        ...
        <Tabs defaultValue="profile">
          <div className="flex items-center justify-between px-4 border-b">
            <TabsList className="h-auto gap-0 rounded-none bg-transparent p-0">
              <TabsTrigger
                value="profile"
                className="rounded-none border-b-[3px] border-transparent px-4 py-3 text-[15px] font-semibold text-gray-500 shadow-none data-[state=active]:text-primary data-[state=active]:border-primary data-[state=active]:bg-transparent data-[state=active]:shadow-none"
              >
                Profile Details
              </TabsTrigger>
              <TabsTrigger
